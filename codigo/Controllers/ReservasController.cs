...
namespace codigo.Controllers
{
    ...
    public class ReservasController : ControllerBase
    {
        ...
        public ReservasController(LocacaoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Reserva>> PostReserva(Reserva reserva)
        {
            ...
            {
                return BadRequest("O ID do cliente deve ser informado.");
            }
            // Verifica se o veículo existe e se está disponível
            ...
            {
                return BadRequest("Este veículo já está reservado.");
            }
